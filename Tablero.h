...
public:
   ...
   //para hacer condiciones donde si alguna de estas 2 es true, el jugador pueda seguir tirando dados si tiroDados=true y (moverFicha || colocarFicha) =false, revertir todos los movimientos que hizo
   bool moverFicha=false, colocarFicha=false, tiroDados=false;
    ...
    void imprimirTablero()
	{
		...
		for (int col = 0; col < board.size(); col++) 
		{
			...
			cout << " Fila " << (col + 2) << endl; // Columna empieza en 2
		}
		cout << endl;
	}
};
